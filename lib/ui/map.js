...
function onAddGround( world, groundObj ){
    ...
    if( !contains ){
        ...
        if( !groundBox ){
            ...
            groundBox.setIndex( 2 );
        }

        groundBox.left =    2 * ( groundObj.x - viewport.x0 );
        groundBox.top =     groundObj.y - viewport.y0;
        groundBox.hidden && groundBox.show();
        renderScreen();
    }
}///
